...
@section('content')
    ...
    <div class="content-wrapper content-aside">
        ...
        <section class="content-header">
            <h1 class="text-center">Add Call Of Extra Duty Leave Form</h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <form action="{{route('leaves.callOfExtraDuty.store')}}" method="POST" id="compensatoryLeaveForm">
                            {{ csrf_field() }}
                            <div class="box-body">
                                @if($errors->any())
        ...
        $(".selectTime").on('changeTime.timepicker', function(e){
            ...
            if(Date.parse(inTime) >= Date.parse(outTime)){
                ...
                if(timeDiff < 4){
                    ...
                    $(".hourErrors").text("Number of hours should be greater than or equal to 4.").css("color","#f00");
